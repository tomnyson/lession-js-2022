...
// console.log("____________________Bài____5______________");
...
// let Bai5A = prompt("(Bài 5) Nhập Tên Sản Phẩm : ");
// const Bai5B = prompt("(Bài 5) Nhập Số Lượng : ");
// const Bai5C = prompt("(Bài 5) Nhập Đơn giá : ");

// console.log("Tên Sản Phẩm :" , Bai5A);
// console.log("Số lượng :" , Bai5B);
// console.log("đơn giá :" , Bai5C);

// const Tien = (Number(Bai5B) * Number(Bai5C));   // b*b - 4*a*c;
// console.log(+ Bai5A + " Có Giá là :" + Tien);

// let thue = 0.1 * Tien
// console.log(+ Bai5A + " Đóng thuế 10% , đơn hàng có giá là :" + thue);


//Nhập quý
// const Quy = prompt("Nhập tháng từ 1 -> 12 : ");
// console.log("tháng bạn vừa nhập là :" + Quy );

// switch(Quy){
//   case 1:
//   case 2:
//   case 3:
//     console.log("tháng vừa nhập là Quý 1", Quy);
//   break;
...
//   case 5:
//   case 6:
//   console.log("tháng vừa nhập là Quý 2", Quy);
//   break;
...
//   case 8:
//   case 9:
//   console.log("tháng vừa nhập là Quý 3", Quy);
//   break;
...
//   case 11:
//   case 12:
//   console.log("tháng vừa nhập là Quý 4", Quy);
//   break;
